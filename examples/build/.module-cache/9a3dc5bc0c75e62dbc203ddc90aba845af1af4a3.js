    ...
    return (
      React.createElement("div", null, 
        React.createElement("h4", null, "tag form"), 
          ...
          React.createElement("input", {type: "text", id: "newtag_id", value: this.props.tags, onChange: this.handleChange}), 
...
var TagManageBox = React.createClass({displayName: "TagManageBox",
  ...
  handleInput: function(tag){
    console.log(tag);
    var oldTag = this.state.inputData;
    this.setState({inputData: oldTag + ' ' + tag});
    ...
    return (
      React.createElement("div", null, 
        React.createElement("h4", null, "tag manage box"), 
          ...
          React.createElement(TagForm, {tags: this.state.inputData, submit: this.handleSubmit}), 
